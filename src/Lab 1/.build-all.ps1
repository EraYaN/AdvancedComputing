...
$measured = Measure-Command {$buildSucceeded = Invoke-MsBuild -Path "MSBuild.csproj" -MsBuildParameters '/m /t:Build /nr:false' -ShowBuildOutputInCurrentWindow -AutoLaunchBuildLogOnFailure -AutoLaunchBuildErrorsLogOnFailure}
