...
void printComParams(cellCompParams *cellCompParamsPtr) {
	...
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->dend.V_dend);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->dend.Hcurrent_q);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->dend.Calcium_r);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->dend.Potassium_s);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->dend.I_CaH);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->dend.Ca2Plus);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->soma.g_CaL);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->soma.V_soma);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->soma.Sodium_m);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->soma.Sodium_h);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->soma.Calcium_k);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->soma.Calcium_l);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->soma.Potassium_n);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->soma.Potassium_p);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->soma.Potassium_x_s);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->axon.V_axon);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->axon.Sodium_m_a);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->axon.Sodium_h_a);
	printf("Prev State: %f\n", cellCompParamsPtr->prevCellState->axon.Potassium_x_a);

	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->dend.V_dend);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->dend.Hcurrent_q);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->dend.Calcium_r);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->dend.Potassium_s);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->dend.I_CaH);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->dend.Ca2Plus);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->soma.g_CaL);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->soma.V_soma);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->soma.Sodium_m);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->soma.Sodium_h);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->soma.Calcium_k);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->soma.Calcium_l);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->soma.Potassium_n);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->soma.Potassium_p);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->soma.Potassium_x_s);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->axon.V_axon);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->axon.Sodium_m_a);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->axon.Sodium_h_a);
	printf("Next State: %f\n", cellCompParamsPtr->nextCellState->axon.Potassium_x_a);
...
void ComputeOneCell(cellCompParams *cellCompParamsPtr) {
	...
	//printComParams(cellCompParamsPtr);
...
void CompDend(cellCompParams *cellCompParamsPtr) {
	...
	chPrms.newComp1 = &cellCompParamsPtr->nextCellState->dend.Hcurrent_q;
	//Compute
	DendHCurr(&chPrms);
	...
	chPrms.newComp1 = &cellCompParamsPtr->nextCellState->dend.Potassium_s;
	//Compute
	DendKCurr(&chPrms);
	...
	chComps.newVDend = &cellCompParamsPtr->nextCellState->dend.V_dend;
	chComps.vSoma = &cellCompParamsPtr->prevCellState->soma.V_soma;
	chComps.q = &cellCompParamsPtr->nextCellState->dend.Hcurrent_q;
	chComps.r = &cellCompParamsPtr->nextCellState->dend.Calcium_r;
	chComps.s = &cellCompParamsPtr->nextCellState->dend.Potassium_s;
	chComps.newI_CaH = &cellCompParamsPtr->nextCellState->dend.I_CaH;
	DendCurrVolt(&chComps);
	//printf("%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n", chComps.iC, *chComps.iApp, *chComps.vDend, *chComps.newVDend, *chComps.vSoma, *chComps.q, *chComps.r, *chComps.s, *chComps.newI_CaH);
	return;
}
...
void CompSoma(cellCompParams *cellCompParamsPtr) {
	...
	chPrms.newComp1 = &cellCompParamsPtr->nextCellState->soma.Calcium_k;
	chPrms.newComp2 = &cellCompParamsPtr->nextCellState->soma.Calcium_l;
	//Compute
	SomaCalcium(&chPrms);
	...
	chPrms.newComp1 = &cellCompParamsPtr->nextCellState->soma.Sodium_m;
	chPrms.newComp2 = &cellCompParamsPtr->nextCellState->soma.Sodium_h;
	//Compute
	SomaSodium(&chPrms);
	...
	chPrms.newComp1 = &cellCompParamsPtr->nextCellState->soma.Potassium_n;
	chPrms.newComp2 = &cellCompParamsPtr->nextCellState->soma.Potassium_p;
	//Compute
	...
	chPrms.newComp1 = &cellCompParamsPtr->nextCellState->soma.Potassium_x_s;
	//Compute
	...
	chComps.vDend = &cellCompParamsPtr->prevCellState->dend.V_dend;
	chComps.vSoma = &cellCompParamsPtr->prevCellState->soma.V_soma;
	chComps.newVSoma = &cellCompParamsPtr->nextCellState->soma.V_soma;
	chComps.vAxon = &cellCompParamsPtr->prevCellState->axon.V_axon;
	chComps.k = &cellCompParamsPtr->nextCellState->soma.Calcium_k;
	chComps.l = &cellCompParamsPtr->nextCellState->soma.Calcium_l;
	chComps.m = &cellCompParamsPtr->nextCellState->soma.Sodium_m;
	chComps.h = &cellCompParamsPtr->nextCellState->soma.Sodium_h;
	chComps.n = &cellCompParamsPtr->nextCellState->soma.Potassium_n;
	chComps.x_s = &cellCompParamsPtr->nextCellState->soma.Potassium_x_s;
...
void CompAxon(cellCompParams *cellCompParamsPtr) {
	...
	chPrms.newComp1 = &cellCompParamsPtr->nextCellState->axon.Sodium_h_a;
	chPrms.newComp2 = &cellCompParamsPtr->nextCellState->axon.Sodium_m_a;
	//Compute
	AxonSodium(&chPrms);
	...
	chPrms.newComp1 = &cellCompParamsPtr->nextCellState->axon.Potassium_x_a;
	//Compute
	...
	chComps.vSoma = &cellCompParamsPtr->prevCellState->soma.V_soma;
	chComps.vAxon = &cellCompParamsPtr->prevCellState->axon.V_axon;
	chComps.newVAxon = &cellCompParamsPtr->nextCellState->axon.V_axon;
	chComps.m_a = &cellCompParamsPtr->nextCellState->axon.Sodium_m_a;
	chComps.h_a = &cellCompParamsPtr->nextCellState->axon.Sodium_h_a;
	chComps.x_a = &cellCompParamsPtr->nextCellState->axon.Potassium_x_a;
